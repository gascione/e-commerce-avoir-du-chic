      ...
      <section className="bg-home bg-center bg-cover min-h-96">
        <div className="h-96 mx-auto sm:py-16 lg:px-6 backdrop-blur-sm bg-black bg-opacity-50 flex items-center">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a
              href="#"
              className="text-slate-900 bg-slate-50 hover:bg-slate-500 focus:ring-4 focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none"
            >
              Buy now
            </a>
          </div>
